/*
The following C program is to measure the size of L1 and L2 caches
- using capacity misses.
...
The program assumes there are separate data and instruction caches
*/
